...
import { Link, createLazyFileRoute } from '@benjavicente/angular-router-experimental';
import { DecimalPipe } from '@angular/common';
import { Title } from '@angular/platform-browser';
import {
  injectCartClient,
  injectCartClientItemCount,
  ...
  <div class="mx-auto w-full max-w-app px-4 md:px-6 lg:px-8">
    @if (cartClient.isEmpty()) {
      ...
      <div class="grid grid-cols-1 items-start gap-8 md:grid-cols-[1fr_320px]">
        ...
        <aside class="sticky top-20 flex flex-col gap-4 rounded-lg border border-border bg-surface p-6">
